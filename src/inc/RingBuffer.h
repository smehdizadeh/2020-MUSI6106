...
public:
        ...
        m_iBuffLength(iBufferLengthInSamples)
    {
        ...
        // allocate and init
        m_piBuff = new T[m_iBuffLength]; //allocate memory
        reset(); //init buffer and indeces with 0
    }
    ...
    virtual ~CRingBuffer ()
    {
        ...
        delete[] m_piBuff; //delete
        m_piBuff = 0; //set to null
    }
    ...
    */
    void setWriteIdx (int iNewWriteIdx)
    {
        ...
        {
            m_iWriteIdx = iNewWriteIdx % m_iBuffLength; //index is new index mod buff length
        }
        else
    ...
    */
    void setReadIdx (int iNewReadIdx)
    {
        ...
        {
            m_iReadIdx = iNewReadIdx % m_iBuffLength; //index is new index mod buff length
        }
        else
